...
/**
 * Represents an authenticated CodeStory session with user and subscription details
 */
...
/**
 * Structure for encoded token data used in authentication
 */
...
/**
 * Represents the current usage metrics for a subscription
 */
...
/**
 * Determines if a given subscription status allows access to CodeStory features
...
export interface ICSAccountService {
	...
	/**
	 * Ensures the user is authorized and has valid access
